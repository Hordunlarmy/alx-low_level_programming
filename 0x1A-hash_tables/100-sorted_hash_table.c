 ...
 * Return: a pointer to newly sorted table
 */
shash_table_t *shash_table_create(unsigned long int size)
{
	shash_table_t *ht;
...
/**
 * shash_table_print - Function tha prints
 *                     a sorted hash table in order.
 * @ht: A pointer to the sorted hash table.
 * Return: Nada
 */
void shash_table_print(const shash_table_t *ht)
...
/**
 * shash_table_print_rev - Function that prints a
...
/**
 * shash_table_delete - Function that deletes
 *                     a sorted hash table.
 * @ht: A pointer to the sorted hash table.
 * Return: Nada
 */
